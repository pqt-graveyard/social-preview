...
import { Option } from '../components/previews/Option';
...
export default (): ReactElement => {
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 space-x-8 flex-row flex">
        <div className="flex-auto w-4/6">
          <div className="sticky top-4 sm:top-6 lg:top-8 space-y-4">
            <div
              className={classNames([
                'relative inline-flex shadow-sm rounded border border-gray-300 bg-gray-100 p-1 md:p-2 lg:p-3 overflow-hidden transition-opacity items-center duration-150',
        ...
        <div className="flex-auto w-2/6 grid grid-cols-1 gap-8 items-start justify-evenly pb-4 sm:pb-6 lg:pb-8">
          <Option
            selected={selected === 'base'}
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/209282/base.png"
            alt=""
          ...
          <Option
            ...
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/209282/base.png"
            alt=""
            onClick={() => setSelected('base1')}
          />
          <Option
            selected={selected === 'base2'}
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/209282/base.png"
            alt=""
            onClick={() => setSelected('base2')}
          />
          <Option
            selected={selected === 'base3'}
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/209282/base.png"
            alt=""
            onClick={() => setSelected('base3')}
          />
          <Option
            selected={selected === 'base4'}
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/209282/base.png"
            alt=""
            onClick={() => setSelected('base4')}
          />
        </div>
      </div>
    </Layout>
