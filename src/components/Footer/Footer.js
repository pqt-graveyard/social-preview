          ...
          <div className="bg-white border-t border-gray-100">
            <div className="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
              <div className="flex justify-center md:order-2">
                <OutboundLink
                  href="https://github.com/pqt/social-preview"
              ...
              <div className="mt-8 md:mt-0 md:order-1">
                <p className="text-base leading-6 text-center text-gray-400">
                  &copy; {data.site.siteMetadata.copyright.year}{" "}
                  <OutboundLink href="https://github.com/pqt" className="hover:text-gray-500">
                    {data.site.siteMetadata.copyright.text}
                  </OutboundLink>{" "}
